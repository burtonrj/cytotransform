...
PYBIND11_MODULE(logicle_ext, m) {
    m.doc() = "Python bindings for FastLogicle C++ implementation";

    py::class_<FastLogicle>(m, "FastLogicle")
        .def(py::init<double, double, double, double, int>(),
             py::arg("T"), py::arg("W"), py::arg("M"), py::arg("A"), py::arg("bins"))
        .def(py::init<double, double, double, int>(),
             py::arg("T"), py::arg("W"), py::arg("M"), py::arg("bins"))
        .def(py::init<double, double, int>(),
             py::arg("T"), py::arg("W"), py::arg("bins"))
        .def(py::init<double, double, double, double>(),
             py::arg("T"), py::arg("W"), py::arg("M"), py::arg("A"))
        .def(py::init<double, double, double>(),
             py::arg("T"), py::arg("W"), py::arg("M"))
        .def(py::init<double, double>(),
             py::arg("T"), py::arg("W"))
        .def("int_scale", &FastLogicle::intScale, "A function to scale integer values",
             py::arg("value"))
        .def("scale", &FastLogicle::scale, "A function to scale double values",
             py::arg("value"))
        .def("inverse", (double (FastLogicle::*)(double) const) &FastLogicle::inverse, "A function to get inverse of double values",
             py::arg("scale"))
        .def("inverse", (double (FastLogicle::*)(int) const) &FastLogicle::inverse, "A function to get inverse of integer values",
             py::arg("index"));
}
